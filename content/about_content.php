...
<div class="container">
<!-- bootrap class = "mx-auto d-block" pour mettre au centre -->
<img class="img-fluid rounded about-heading-img mb-3 mb-lg-0 col-xl-6 mx-auto d-block" src="assets/img/about.jpg" alt="..." />                
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                ...
                                <p class="mb-0">
                                Afin que vous puissiez <em>en famille et entre amis </em>continuer à perpetuer l'art de la patisserie. Parce que c'est toujours un plaisir de partager !
                                </p>
                            </div>
                        </div>
                    </div>
